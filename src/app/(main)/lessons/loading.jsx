  ...
  return (
    <div className="w-full min-h-[80vh] flex flex-col items-center justify-center bg-[#F6F0DD]">
      <div className="relative animate-bounce">
        ...
        <div
          className="absolute -top-6 -right-4 w-4 h-4 rounded-full border-[2px] border-[#1C1611] bg-[#FF4A3A] animate-ping"
          style={{ animationDelay: "0ms", animationDuration: "1.5s" }}
        />
        <div
          className="absolute -top-10 -right-1 w-6 h-6 rounded-full border-[2.5px] border-[#1C1611] bg-[#FCD34D] animate-ping"
          style={{ animationDelay: "300ms", animationDuration: "1.5s" }}
        />
        <div
          className="absolute -top-16 right-4 w-8 h-8 rounded-full border-[3px] border-[#1C1611] bg-[#4DD0B1] animate-ping"
